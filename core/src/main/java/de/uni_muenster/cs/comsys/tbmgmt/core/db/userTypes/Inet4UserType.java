 ...
 */
public class Inet4UserType implements UserType {
    public static final String TYPE_STRING    = "de.uni_muenster.cs.comsys.tbmgmt.core.db.userTypes.Inet4UserType";
    ...
    public Object nullSafeGet(final ResultSet rs, final String[] names, final SharedSessionContractImplementor session,
        ...
        try {
            ...
            TypeMismatchException ex = new TypeMismatchException(
                    String.format("Could not read %s as Inet4Address", value));
            ex.initCause(e);
            throw ex;
        }
    }
    ...
    public void nullSafeSet(final PreparedStatement st, final Object value, final int index,
        ...
        if (!(value instanceof Inet4Address)) {
            throw new TypeMismatchException(String.format("%s is not of type Inet4Address", value));
        }
        PGobject pGobject = new PGobject();
        pGobject.setType(PG_TYPE_STRING);
        pGobject.setValue(((Inet4Address) value).getHostAddress());
